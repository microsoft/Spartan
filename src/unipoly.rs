...
impl QuadPoly {
  pub fn new(eval_0: Scalar, eval_1: Scalar, eval_2: Scalar) -> Self {
    QuadPoly {
      eval_0,
      eval_1,
      eval_2,
...
#[allow(dead_code)]
impl CubicPoly {
  pub fn new(eval_0: Scalar, eval_1: Scalar, eval_2: Scalar, eval_3: Scalar) -> Self {
    CubicPoly {
      eval_0,
      eval_1,
      eval_2,
  ...
  pub fn eval_at_two(&self) -> Scalar {
    self.eval_2
  }

  pub fn eval_at_three(&self) -> Scalar {
    self.eval_3
  }
}
...
impl SumcheckProofPolyABI for QuadPoly {
  ...
  fn evaluate(&self, r: &Scalar) -> Scalar {
    ...
    two_inv * rk_2 * rk_1 * self.eval_0 - rk_2 * r * self.eval_1 + two_inv * r * rk_1 * self.eval_2
  }
}
...
impl SumcheckProofPolyABI for CubicPoly {
  ...
  fn evaluate(&self, r: &Scalar) -> Scalar {
    ...
    -(inv_6 * r_minus_1 * r_minus_2 * r_minus_3 * self.eval_0)
      + (inv_2 * r * r_minus_2 * r_minus_3 * self.eval_1)
